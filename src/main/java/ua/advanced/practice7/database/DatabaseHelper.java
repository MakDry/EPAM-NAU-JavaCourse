package ua.advanced.practice7.database;

import ua.advanced.practice7.Entities.Person;
        ...
        try {
            ...
            while (rs.next()) {
                if (rs.getString("FilmTitle").equals(title)) {
                    ...
                    actors.add(new Person(name, surname, patronymic, dateOfBirth));
                }
            }
        } catch (SQLException e) {
            e.printStackTrace();
    ...
    public List<Person> getActorsAsDirector() throws SQLException {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String patronymic = rs.getString("Patronymic");
                String dateOfBirth = rs.getString("DateOfBirth");
                directors.add(new Person(name, surname, patronymic, dateOfBirth));
            }
        } catch (SQLException e) {
            e.printStackTrace();
        } finally {
